#!/usr/bin/env python3
"""
Retired Stage4 strict-float A/B runner.

This script used to pass the historical CMake flag
`DNG_RENDER_STAGE4_STRICT_FLOAT` and parse `[RenderHalide]` /
...
RETIRED_MESSAGE = """\
run_stage4_strictfloat_ab.py is retired.
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Retired Stage4 strict-float A/B runner."
    )
    parser.add_argument(
        "--allow-retired",
        action="store_true",
