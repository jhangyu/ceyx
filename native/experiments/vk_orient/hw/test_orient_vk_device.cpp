...
#include "v3_common.h"
#include "k_vk_gt_on.h"
#include "k_vk_gt_off.h"
#include "k_ref_cpu.h"
...
int invoke(KernelFn fn, Buffer<uint16_t> &src, int w, int h, int stride, int o,
    ...
    return fn(src, w, h, stride, o, w, h, /*crop_l=*/0, /*crop_t=*/0,
              /*src_scale=*/1.0f / 65535.0f, p.exp_ramp, p.tone_curve,
